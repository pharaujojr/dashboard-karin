...
public class DashboardController {
    ...
    public String dashboard(Model model) {
        ...
        DashboardResponse dadosDashboard = vendaService.getDadosDashboard(null, null, dataInicio, dataFim, false, "hoje");
    ...
    logger.debug("/api/dashboard called with filial={}, vendedor={}, dataInicio={}, dataFim={}, agruparPorMes={}, tipoPeriodo={}",
        filial, vendedor, dataInicio, dataFim, agruparPorMes, tipoPeriodo);
    DashboardResponse response = vendaService.getDadosDashboard(filial, vendedor, dataInicio, dataFim, agruparPorMes, tipoPeriodo);
